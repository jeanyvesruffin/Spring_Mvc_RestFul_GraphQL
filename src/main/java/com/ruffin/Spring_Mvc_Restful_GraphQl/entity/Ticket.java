...
/**
 * Classe representant l'Entité == ticket
 * @author admin
 *
 */
...
public class Ticket {
	...
	public Ticket(String status, String title, String description, Application application, Release release) {
		super();
		this.status = status;
		this.title = title;
